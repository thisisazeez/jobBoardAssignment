              ...
              <div className="profile-info">
                ...
                <address>
                  <p>
                    ...
                    <br />
                    Phone: +012 345 678 910 <br />
                    Email:
                    <a href="#">
                      <span
                        className="__cf_email__"
                        data-cfemail="fc95888f9199bc8f898e869590999b999997d29f9391"
                      >
                        [email&nbsp;protected]
                      </span>
                    </a>
            ...
            <div className="personal-deatils section">
              ...
              <div className="personal-info">
                ...
                <ul className="address">
                  ...
                  <li>
                    <h5>Father's Name</h5>
                    <span>:</span>Robert Doe
                  </li>
                  <li>
                    <h5>Mother's Name</h5>
                    <span>:</span>Ismatic Roderos Doe
                  </li>
                  <li>
                    <h5>Date of Birth</h5>
                  ...
                  <li>
                    <h5>Address</h5>
                    <span>:</span>121 King Street, Melbourne Victoria, 1200 USA
                  </li>
                </ul>
              </div>
            </div>
